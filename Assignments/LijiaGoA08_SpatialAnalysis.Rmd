...
Lancaster.sf <- counties_sf.utm %>%
  filter(NAME == "Lancaster")

#23 Select gages within the selected county
gages.intersect <- usgsgage.sf.utm[Lancaster.sf,]


#24 Plot
mapview(counties_sf.utm, col.regions="grey", alpha=0.7) + mapview(Lancaster.sf, alpha=1) + mapview(gages.intersect, col.regions="red", cex=4)
