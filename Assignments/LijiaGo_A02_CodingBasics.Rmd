...
hundredseq_mean <- mean(hundredseq) # computing the mean of the sequence using the mean function
hundredseq_mean # print result

hundredseq_median <- median(hundredseq) # computing the median of the sequence using the median function
