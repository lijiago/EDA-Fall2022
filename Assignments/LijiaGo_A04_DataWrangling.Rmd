...
O3_NC2018.selectcols <- select(O3_NC2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY:SITE_LONGITUDE)

#4b selecting relevant columns for O3_NC2019
O3_NC2019.selectcols <- select(O3_NC2019, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY:SITE_LONGITUDE)

#4c selecting relevant columns for PM25_NC2018
PM25_2018.selectcols <- select(PM25_NC2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY:SITE_LONGITUDE)

#4d selecting relevant columns for PM25_NC2019
PM25_2019.selectcols <- select(PM25_NC2019, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY:SITE_LONGITUDE)
...
write.csv(O3_NC2018.selectcols, row.names = FALSE, file =
            "./Data/Processed/EPAair_O3_NC2018_processed.csv")

write.csv(O3_NC2019.selectcols, row.names = FALSE, file =
            "./Data/Processed/EPAair_O3_NC2019_processed.csv")

write.csv(PM25_2018.selectcols, row.names = FALSE, file =
            "./Data/Processed/EPAair_PM25_NC2018_processed.csv")

write.csv(PM25_2019.selectcols, row.names = FALSE, file =
