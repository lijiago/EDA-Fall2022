...
step(Temp.AIC)
#why stepwise doesnt go step by step? 

Temp.model <- lm(data = NTL.processed, temperature_C ~ year4 + daynum + depth)
summary(Temp.model)
...
>Answer: Lakes that have the same mean temperature statistically to Peter Lake are Central Long Lake, Crampton Lake, East Long Lake and Hummingbird Lake, as the lakes in these pairings all have p values < 0.05. 
