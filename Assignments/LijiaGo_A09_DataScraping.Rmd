...
#2
DEQ_website <- read_html("https://www.ncwater.org/WUDC/app/LWSP/report.php?pwsid=03-32-010&year=2021")
...
ggplot(df_withdrawals, aes(x=Date, y=Max_Withdrawals_mgd)) +
  ...
  xlab("2021") +
  ggtitle("2021 maximum daily water withdrawals per month, Durham (NC)")
